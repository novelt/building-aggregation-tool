...
extern "C" {
    pub fn VSIFRead(arg1: *mut libc::c_void, arg2: size_t, arg3: size_t, arg4: *mut FILE)
        -> size_t;
}
extern "C" {
    pub fn VSIFWrite(
...
extern "C" {
    pub fn VSICalloc(arg1: size_t, arg2: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn VSIMalloc(arg1: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn VSIFree(arg1: *mut libc::c_void);
}
extern "C" {
    pub fn VSIRealloc(arg1: *mut libc::c_void, arg2: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn VSIStrdup(arg1: *const libc::c_char) -> *mut libc::c_char;
}
extern "C" {
    pub fn VSIMallocAligned(nAlignment: size_t, nSize: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn VSIMallocAlignedAuto(nSize: size_t) -> *mut libc::c_void;
}
extern "C" {
...
extern "C" {
    pub fn VSIMalloc2(nSize1: size_t, nSize2: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn VSIMalloc3(nSize1: size_t, nSize2: size_t, nSize3: size_t) -> *mut libc::c_void;
}
extern "C" {
...
pub struct VSIFilesystemPluginCallbacksStruct {
    ...
    pub nBufferSize: size_t,
    pub nCacheSize: size_t,
...
extern "C" {
    pub fn CPLMalloc(arg1: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn CPLCalloc(arg1: size_t, arg2: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn CPLRealloc(arg1: *mut libc::c_void, arg2: size_t) -> *mut libc::c_void;
}
extern "C" {
...
extern "C" {
    pub fn OGRMalloc(arg1: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn OGRCalloc(arg1: size_t, arg2: size_t) -> *mut libc::c_void;
}
extern "C" {
    pub fn OGRRealloc(arg1: *mut libc::c_void, arg2: size_t) -> *mut libc::c_void;
}
extern "C" {
...
pub type OGRBoolean = libc::c_int;
...
pub mod OGRwkbVariant {
    pub type Type = libc::c_uint;
    pub const wkbVariantOldOgc: Type = 0;
    pub const wkbVariantIso: Type = 1;
...
pub mod ogr_style_tool_param_pen_id {
    pub type Type = libc::c_uint;
    pub const OGRSTPenColor: Type = 0;
    pub const OGRSTPenWidth: Type = 1;
    pub const OGRSTPenPattern: Type = 2;
    pub const OGRSTPenId: Type = 3;
    pub const OGRSTPenPerOffset: Type = 4;
    pub const OGRSTPenCap: Type = 5;
    pub const OGRSTPenJoin: Type = 6;
    pub const OGRSTPenPriority: Type = 7;
    pub const OGRSTPenLast: Type = 8;
}
pub use self::ogr_style_tool_param_pen_id::Type as OGRSTPenParam;
pub mod ogr_style_tool_param_brush_id {
    pub type Type = libc::c_uint;
    pub const OGRSTBrushFColor: Type = 0;
    pub const OGRSTBrushBColor: Type = 1;
    pub const OGRSTBrushId: Type = 2;
    pub const OGRSTBrushAngle: Type = 3;
    pub const OGRSTBrushSize: Type = 4;
    pub const OGRSTBrushDx: Type = 5;
    pub const OGRSTBrushDy: Type = 6;
    pub const OGRSTBrushPriority: Type = 7;
    pub const OGRSTBrushLast: Type = 8;
}
pub use self::ogr_style_tool_param_brush_id::Type as OGRSTBrushParam;
pub mod ogr_style_tool_param_symbol_id {
    pub type Type = libc::c_uint;
    pub const OGRSTSymbolId: Type = 0;
    pub const OGRSTSymbolAngle: Type = 1;
    pub const OGRSTSymbolColor: Type = 2;
    pub const OGRSTSymbolSize: Type = 3;
    pub const OGRSTSymbolDx: Type = 4;
    pub const OGRSTSymbolDy: Type = 5;
    pub const OGRSTSymbolStep: Type = 6;
    pub const OGRSTSymbolPerp: Type = 7;
    pub const OGRSTSymbolOffset: Type = 8;
    pub const OGRSTSymbolPriority: Type = 9;
    pub const OGRSTSymbolFontName: Type = 10;
    pub const OGRSTSymbolOColor: Type = 11;
    pub const OGRSTSymbolLast: Type = 12;
}
pub use self::ogr_style_tool_param_symbol_id::Type as OGRSTSymbolParam;
pub mod ogr_style_tool_param_label_id {
    pub type Type = libc::c_uint;
    pub const OGRSTLabelFontName: Type = 0;
    pub const OGRSTLabelSize: Type = 1;
    pub const OGRSTLabelTextString: Type = 2;
    pub const OGRSTLabelAngle: Type = 3;
    pub const OGRSTLabelFColor: Type = 4;
    pub const OGRSTLabelBColor: Type = 5;
    pub const OGRSTLabelPlacement: Type = 6;
    pub const OGRSTLabelAnchor: Type = 7;
    pub const OGRSTLabelDx: Type = 8;
    pub const OGRSTLabelDy: Type = 9;
    pub const OGRSTLabelPerp: Type = 10;
    pub const OGRSTLabelBold: Type = 11;
    pub const OGRSTLabelItalic: Type = 12;
    pub const OGRSTLabelUnderline: Type = 13;
    pub const OGRSTLabelPriority: Type = 14;
    pub const OGRSTLabelStrikeout: Type = 15;
    pub const OGRSTLabelStretch: Type = 16;
    pub const OGRSTLabelAdjHor: Type = 17;
    pub const OGRSTLabelAdjVert: Type = 18;
    pub const OGRSTLabelHColor: Type = 19;
    pub const OGRSTLabelOColor: Type = 20;
    pub const OGRSTLabelLast: Type = 21;
}
pub use self::ogr_style_tool_param_label_id::Type as OGRSTLabelParam;
extern "C" {
...
pub struct OGRContourWriterInfo {
    pub hLayer: *mut libc::c_void,
    pub adfGeoTransform: [f64; 6usize],
    pub nElevField: libc::c_int,
    pub nElevFieldMin: libc::c_int,
    pub nElevFieldMax: libc::c_int,
    pub nIDField: libc::c_int,
    pub nNextID: libc::c_int,
}
#[test]
